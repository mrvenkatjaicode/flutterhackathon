...
class StoryScreen3 extends StatelessWidget {
  const StoryScreen3({super.key});
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                const Text(
                  "Make and impact on how\npeople listen to music",
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 30),
                ),
                const SizedBox(height: 20),
                const Text(
                  "Millions of people will enjoy your contributions within the most popular streaming services",
